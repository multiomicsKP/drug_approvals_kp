...
def load_data(data_folder):
    edges_file_path = os.path.join(data_folder, "drug_approvals_kg_edges_v0.5.3.tsv")
    nodes_file_path = os.path.join(data_folder, "drug_approvals_kg_nodes_v0.5.3.tsv")
